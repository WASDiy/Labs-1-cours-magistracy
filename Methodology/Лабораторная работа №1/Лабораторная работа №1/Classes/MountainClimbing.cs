...
{
	//Класс Search. Поиск маршрута с помощью эвристики восхождения на гору
	class MountainClimbing : IAlgorithm
	{
		...
		public MountainClimbing(List<FlightInfo> f)
        {
			flights = f;
        }
